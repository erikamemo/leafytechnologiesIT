...
<li><a href="<?php echo $root; ?>prodotti/">Prodotti</a></li></ul>
      ...
      <div class="crumb-now">
        <div> <span><a href="<?php echo $root; ?>prodotti/sensori-in-linea/">Misuratore elettrochimici</a></span> </div>
      </div>
    </div>
  </div>
</section>
...
<section class="wrapper-a">
      <div class="container container-padding">
        <article class="center-page-article">
          <p style="text-align:center;">Palintest offre una gamma di contatori elettrochimici per tutti i budget e requisiti di prestazione, dai semplici contatori tascabili agli avanzati sistemi di analisi della qualità dell'acqua.</p>
        </article>
      </div>
    </section>
...
<section class="wrapper-a">
  <div class="container container-padding">
    <div class="grid-2-columns">
      ...
      <?php include( '../../includes/snippets/sensore-tascabile-conducibilita.php' ); ?>
      <?php include( '../../includes/snippets/sensore-tascabile-ph.php' ); ?>
      <?php include( '../../includes/snippets/sensore-tascabile-tds.php' ); ?>
      <?php include( '../../includes/snippets/misuatori-elettrochimici-piscina.php' ); ?>
    </div>
  </div>
</section>
<!-- sensori list end --> 
