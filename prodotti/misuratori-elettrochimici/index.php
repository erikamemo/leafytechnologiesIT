...
<section class="wrapper-a">
  <div class="container container-padding">
    <div class="grid-2-columns">
      ...
      <?php include( '../../includes/snippets/micro-800-do.php' ); ?>
      <?php include( '../../includes/snippets/micro-8100-ph.php' ); ?>
      <?php include( '../../includes/snippets/micro-800-conducibilità.php' ); ?>
      ...
      <?php include( '../../includes/snippets/micro-600-conducibilità.php' ); ?>
