...
-->            </ul>
          ...
          <li class="menu-btn-2 products dropdown"> <span class="title-reference with-arrow">Analizzatori portatili</span>
            <ul class="list">
              ...
              <li><a href="<?php echo $root; ?>prodotti/kemio/">Kemio&trade;</a></li>
              <li><a href="<?php echo $root; ?>prodotti/fotometri/">Fotometri</a></li>
              <li><a href="<?php echo $root; ?>prodotti/wagtech/">Wagtech&trade;</a></li>
              <li><a href="<?php echo $root; ?>prodotti/siren-bw/">Siren<sub>BW</sub></a></li>
              <li><a href="<?php echo $root; ?>prodotti/visual/">Visual</a></li>
              <li><a href="<?php echo $root; ?>prodotti/misuratori-elettrochimici/">Misuratore elettrochimici</a></li>
